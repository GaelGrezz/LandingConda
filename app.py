...
with st.form("contact_form"):
        ...
        checkbox = st.caption("Acepto que mis datos sean utilizados para contactarme respecto a CONDA web.", help="Al llenar y enviar el formulario, aceptas que tus datos sean utilizados exclusivamente para fines de contacto relacionados con CONDA web.", )
